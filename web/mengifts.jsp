<%-- 
    Document   : men_gifts
    Created on : Nov 11, 2024, 11:22:42 PM
    Author     : matur
--%>
...
<body>
    ...
    <div class="gift-grid">
        <%
            ResultSet retriveProduct = DatabaseConnection.getResultFromSqlQuery("SELECT * FROM tblproduct WHERE product_category = 'Best Men Gift'");
